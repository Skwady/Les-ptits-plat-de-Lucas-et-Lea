...
<div class="bg-gradiant text-center p-5 tw">
    <h3 class="pt-3 pb-3">Bienvenue sur notre blog culinaire, où la cuisine rime avec complicité et souvenirs d'enfance !</h3>
    <h5 class="w-100 w-md-75 mx-auto">
