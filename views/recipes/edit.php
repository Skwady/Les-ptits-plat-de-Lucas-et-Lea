...
<form method="post" action="/Recipes/updateRecipe/<?= $recipeId ?>" enctype="multipart/form-data" class="container mt-4 mb-4 bg-gradiant tw-b">
    <div class="mb-3 pt-3">
        <label for="title" class="form-label">Titre :</label>
        <input type="text" class="form-control" id="title" name="title" maxlength="255" value="<?= $recipe->title ?>" required>
    </div>
    ...
    <div class="mb-3">
        ...
        <select class="form-select" id="difficulty" name="difficulty" value="<?= $recipe->difficulty ?>" required>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="cook_time" name="cook_time" pattern="\d*" placeholder="Laissez vide si aucun" value="<?= $recipe->cook_time ?>">
    </div>

    <div class="mb-3">
        <label for="rest_time" class="form-label">Temps de repos (en minutes) :</label>
        <input type="text" class="form-control" id="rest_time" name="rest_time" pattern="\d*" placeholder="Laissez vide si aucun" value="<?= $recipe->rest_time ?>">
    </div>
